...
/usr/bin/pacman -S --noconfirm --overwrite --needed --quiet --noprogressbar --cachedir=/vagrant/pkg_cache yaourt mlocate net-tools strace vim rsync
...
/usr/bin/pacman -S --noconfirm --overwrite --needed --quiet --noprogressbar --cachedir=/vagrant/pkg_cache \
    ...
    joomscan \
    masscan \
    openvas-manager openvas-scanner gsa gsd openvas-cli blackarch/greenbone-security-assistant python2 \
